...
class OriginSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        Origin::factory()->create([
            'index' => 'Snowman',
            'name' => 'Сноу',
            'description' => 'Сноу - это идея об отшельничестве. Отрекаясь от своих тел, души монахов, встречающих свой ритуальный конец в заснеженных вершинах, перерождаются в небольшие снежные вихри или фигуры из снега. Несмотря на их хрупкие тела, Сноу постигли истинную мудрость жизни. Ни живы, ни мертвы - в культурах разных народов они зачастую считаются проводниками в мир мёртвых, предвестниками перемен и мудрыми расказчиками.',
            'average' => 'Не стареют',
            'adulting' => 'Неприменимо'
        ]);
        // Ведьма
        ...
        Origin::factory()->create([
            ...
            'food' => 'Плотоядные',
            'average' => '30 лет',
            'adulting' => 'Проявляется во взрослом возрасте'
        ]);
        // Страж (+ Древний страж)
        Origin::factory()->create([
            'index' => 'Guardian',
