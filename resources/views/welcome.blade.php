...
@section('content')
    <div class="relative">
        ...
        <div class="absolute inset-0 z-0">
            <img src="{{ Vite::asset('resources/images/screenshots/' . $asset) }}" alt=""
                ...
                <div class="w-fit flex flex-col gap-20">
                    ...
                    <div class="flex flex-wrap md:flex-row items-baseline gap-3 mx-auto md:mx-0">
                        ...
                        <div class="mono rounded-md outline-2 outline-zinc-400 bg-zinc-800/80 flex items-center">
                            ...
                            {{-- <button class="border-l-2 border-zinc-400/50 p-2 cursor-pointer" data-clipboard-text="#IP">
        ...
        <div class="flex justify-between flex-col gap-3 md:flex-row sm:w-6/7 lg:w-6/8 mx-auto">
            <div
                ...
                <div class="flex items-center justify-center gap-3 pix">
                    <img src="{{ Vite::asset('resources/images/budgies/sword.png') }}" class="size-10" alt="">
                    <h3 class="text-2xl font-bold">Меч и магия</h3>
                    <img src="{{ Vite::asset('resources/images/budgies/magic.png') }}" class="size-10" alt="">
                </div>
                <hr class="my-2 border-blue-500/50">
                <div class="h-fit max-h-80 lg:max-h-150 overflow-clip rounded-xl bg-zinc-900/40">
                    <img src="{{ Vite::asset('resources/images/choice/wizard.png') }}" alt="">
                </div>
            ...
            <div
                ...
                <div class="flex items-center justify-center gap-3">
                    <img src="{{ Vite::asset('resources/images/budgies/gear.png') }}" class="size-10" alt="">
                    <h3 class="text-2xl font-bold">Наука и прогресс</h3>
                    <img src="{{ Vite::asset('resources/images/budgies/lamp.png') }}" class="size-10" alt="">
                </div>
                <hr class="my-2 border-amber-500/50">
                <div class="h-fit max-h-80 lg:max-h-150 overflow-clip rounded-xl bg-zinc-900/40">
                    <img src="{{ Vite::asset('resources/images/choice/goblin.png') }}" alt="">
                </div>
    ...
    <div class="mx-2 md:mx-auto md:w-5/7 px-5 sm:px-10 md:px-0 text-center rounded-2xl">
        ...
        <div class="flex items-center my-2 mx-auto rounded-xl overflow-clip w-fit">
            <img src="{{ VIte::asset('resources/images/together.png') }}" alt="Совместное фото с концовки прошлого сезона">
        </div>
                ...
                @foreach ($artists as $artist)
                    <a href="{{ $artist['link'] }}" target="_blank"
                        ...
                        <div class="h-20 w-fit rounded-full overflow-clip group-hover:scale-110 duration-300">
                            <img src="{{ Vite::asset('resources/images/artists/' . $artist['pic']) }}" alt=""
                                class="h-full">
                        </div>
                        <div
                ...
                <div class="border-2 p-2 rounded-md border-zinc-400 bg-zinc-800/40">
                    ...
                    <div class="mono">
                        <div class="flex justify-between">
                            <span class="text-xl font-bold">{{ $admin['name'] }}</span>
                            <span class="text-sm py-1 px-2 rounded-full bg-slate-50/10">{{ $admin['job'] }}</span>
                        </div>
